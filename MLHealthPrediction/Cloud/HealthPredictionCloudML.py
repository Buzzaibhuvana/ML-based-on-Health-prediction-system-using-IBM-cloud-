...
def precisionGraph():
    height = [knn_precision,nb_precision,tree_precision,svm_precision,random_precision,logistic_precision,gb_precision,mlp_precision,ensemble_precision]
    bars = ('KNN Precision', 'NB Precision','DT Precision','SVM Precision','RF Precision','LR Precision','Gradient Boosting Precision','MLP Precision','Ensemble Precision')
...
def recallGraph():
    height = [knn_recall,nb_recall,tree_recall,svm_recall,random_recall,logistic_recall,gb_recall,mlp_recall,ensemble_recall]
    bars = ('KNN Recall', 'NB Recall','DT Recall','SVM Recall','RF Recall','LR Recall','Gradient Boosting Recall','MLP Recall','Ensemble Recall')
    y_pos = np.arange(len(bars))
    plt.bar(y_pos, height)
    plt.xticks(y_pos, bars)
    plt.show()
...
def fscoreGraph():
    height = [knn_fmeasure,nb_fmeasure,tree_fmeasure,svm_fmeasure,random_fmeasure,logistic_fmeasure,gb_fmeasure,mlp_fmeasure,ensemble_fmeasure]
    bars = ('KNN FScore', 'NB FScore','DT FScore','SVM FScore','RF FScore','LR FScore','Gradient Boosting  FScore','MLP FScore','Ensemble FScore')
    y_pos = np.arange(len(bars))
    plt.bar(y_pos, height)
    plt.xticks(y_pos, bars)
    plt.show()  
...
def accuracyGraph():
    height = [knn_acc,nb_acc,tree_acc,svm_acc,random_acc,logistic_acc,gb_acc,mlp_acc,ensemble_acc]
    bars = ('KNN ACC', 'NB ACC','DT ACC','SVM ACC','RF ACC','LR ACC','Gradient Boosting ACC','MLP ACC','Ensemble Acc')
    y_pos = np.arange(len(bars))
    plt.bar(y_pos, height)
    plt.xticks(y_pos, bars)
    plt.show()  
